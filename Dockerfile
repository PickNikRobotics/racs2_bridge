...
## Clone cFS
WORKDIR ${HOME_DIR}
RUN git clone --recursive https://github.com/nasa/cFS/ cfs
...
# RUN cp -pr ${HOME_DIR}/racs2_bridge/Example/Case.1/cFS/sample_defs/* ${HOME_DIR}/cfs/sample_defs/
COPY ./Example/Case.1/cFS/sample_defs ${HOME_DIR}/cfs/sample_defs/
# RUN cp -pr ${HOME_DIR}/racs2_bridge/Example/Case.1/cFS/apps/sample_talker ${HOME_DIR}/cfs/apps/
COPY ./Example/Case.1/cFS/apps/sample_talker ${HOME_DIR}/cfs/apps/sample_talker
...
# RUN cp -pr ${HOME_DIR}/racs2_bridge/Example/Case.1/ROS2/* ${HOME_DIR}/ros2-project/src/
COPY ./Example/Case.1/ROS2 ${HOME_DIR}/ros2-project/src/
